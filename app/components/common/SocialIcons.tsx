...
/**
 * Shared social brand marks.
 *
 * The footer and the contact page render the same set of links, so the glyphs
 * live here rather than being duplicated per page (a fix in one place used to
...
/**
 * Threads mark. Stroked (not filled) so the open outer loop and the inner hook
 * stay legible at the small sizes used in the footer/contact grids.
 */
export function ThreadsIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      {/* Outer "a" shell — the open loop of the Threads mark */}
      <path d="M12.5 21.5c-4.9 0-8.5-3.4-8.5-9.5s3.6-9.5 8.5-9.5 8.4 3.3 8.5 9.2" />
      {/* Inner hook — what separates Threads from a plain "a" */}
      <path d="M20.9 12.3c-.2-1.3-.9-2.1-2-2.4-1.4-.4-3 .1-3.7 1.1-.9 1.3-.2 2.9 1.3 3.5 1.6.6 3.4.2 4.2-1 .9-1.3.9-3.4-.2-5-1.5-2.2-4.3-3.5-7.5-3.5-4 0-6.8 2.5-6.8 6.6 0 4.2 2.8 6.7 6.9 6.7 2.5 0 4.3-.9 5.2-2.4" />
    </svg>
  );
}
